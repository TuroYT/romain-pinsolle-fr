          ...
          <div class="col s6">
            <div class="card-panel hoverable <?php echo $materialize_card_color; ?> waves-effect waves-block waves-<?php echo $materialize_waves_color; ?> bigEntrance">
              ...
              <ul id="info" class="bigEntrance" style="font-size:18px">
                ...
                <li>&nbsp;&nbsp;&nbsp;<i class="material-icons mi-valign">games</i>&nbsp;&nbsp;&nbsp;<b>Mode :</b>&nbsp;<div id="gamemode" style="display: inline;">RôlePlay</div></li>
                <li>&nbsp;&nbsp;&nbsp;<i class="material-icons mi-valign">supervisor_account</i>&nbsp;&nbsp;&nbsp;<b>Joeurs max :</b>&nbsp;<div id="maxplayers" style="display: inline;">128</div></li>
                <li>&nbsp;&nbsp;&nbsp;<i class="material-icons mi-valign">language</i>&nbsp;&nbsp;&nbsp;<b>Serveur IP :</b>&nbsp;<?php echo $serverIP; ?>:<?php echo $serverPort; ?></li>
              </ul>
            </div>
            <div class="card-panel hoverable <?php echo $materialize_card_color; ?> waves-effect waves-block waves-<?php echo $materialize_waves_color; ?> bigEntrance">
              <h5 class="center-align bigEntrance"><i class="material-icons mi-valign">description</i>&nbsp;&nbsp;&nbsp;Règlement<h5>
          ...
          <div class="col s6">
            ...
            <div class="card-panel hoverable <?php echo $materialize_card_color; ?> waves-effect waves-block waves-<?php echo $materialize_waves_color; ?> bigEntrance">
              <?php if($youtube_ids[0] == '') { ?>
                ...
                <div class="input-field col s12 bigEntrance">
                  ...
                  <label for="icon_prefix" class="<?php echo $materialize_text_color; ?>-text">En train de jouer :&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $play_name; ?></label>
                </div>
        			<?php } else { ?>
            ...
            <div class="card-panel hoverable <?php echo $materialize_card_color; ?> waves-effect waves-block waves-<?php echo $materialize_waves_color; ?> bigEntrance">
              <div class="valign-wrapper">
                ...
                <h5 class="valign bigEntrance">&nbsp;&nbsp;&nbsp;&nbsp;<i><div id="status" style="display: inline;">Chargement des infos du serveur</div></i></h5>
              </div>
              <div class="right-align bigEntrance"><p><i><div id="fileDL" style="display: inline;">Pas te téléchargement en cours</div></i> [<div id="percent" style="display: inline;">0</div>%]<br>
              <div id="needed" style="display: inline;">nécessaire</div>/<div id="total" style="display: inline;">Total</div></p></div>
